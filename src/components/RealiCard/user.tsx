            ...
            <Box display="flex" justifyContent="space-between" alignItems="center">
                ...
                <Box display="flex" gap={5}>
                    <Box display="flex" flexDirection="column" alignItems="center">
                        ...
                        <p className="text-[18px] font-bold" style={{ color: theme.palette.primary.main }}>2</p>
                    </Box>
                    <Box display="flex" flexDirection="column" alignItems="center">
            ...
            <TabContext value={tabIndex}>
                ...
                <TabPanel value="1">
                    <Box display="flex" flexDirection="column" width="100%">
                        ...
                        <Box display="grid" gridTemplateColumns="2fr 2fr 3fr 1fr" columnGap={3} width="100%" marginTop={2}>
                            <TextField
                                size="medium"
                                variant="filled"
                                label="CAMPEONATO"
                            ...
                            <TextField
                                ...
                                variant="filled"
                                label="CAMPEONATO"
                                value="FLAMENGO X CORINTHIANS (20/05/2024)"
                                className="w-full"
                            />
                        </Box>
                        <Box display="flex" flexDirection="column" padding={3} marginTop={3} borderRadius={3} boxShadow={2} position="relative" width="70%">
                            <Image
                                width={50}
                                height={50}
                                alt=""
