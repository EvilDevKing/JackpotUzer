        ...
        <Box display="flex" flexDirection="column" width="100%" paddingX={3}>
            ...
            <Box display="flex" gap={5} width="100%" marginTop={5}>
                <Box display="flex" flexDirection="column" width="40%">
                    ...
                    <FormControl variant="filled" className="w-full !mt-5">
                    ...
                    <Box display="flex" flexDirection="column" marginTop={3}>
                        ...
                        <Box display="flex" flexDirection="column" marginTop={3}>
                            ...
                            <FormControlLabel
                                ...
                                className={`w-full`}
                            />
                            <button className="relative mt-5 h-auto w-[80%]" onClick={() => inputRef.current?.click()}>
                                {
                                    imageData === '' && <span className="absolute left-[50%] translate-x-[-50%] top-5">Insira uma imagem</span>
                                }
                                <Image
                                    width={0}
                                    height={0}
                ...
                <Box display="flex" width="60%">
                    <Box display="flex" flexDirection="column" width="100%">
                        ...
                        <Box display="flex" flexDirection="column" marginTop={5}>
                            ...
                            <Box display="grid" gridTemplateColumns="1fr 1fr 2fr" columnGap={3} marginTop={1}>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker
                                        label="DATA"
                                        slotProps={{ textField: { variant: 'filled' } }}
                            ...
                            <Box display="flex" gap={2} marginTop={3}>
                                <Box display="flex" flexDirection="column" width="45%">
                                    ...
                                    <button className="relative mt-2 h-auto w-full" onClick={() => inputRef.current?.click()}>
                                        {
                                            imageData === '' && <span className="absolute left-[50%] translate-x-[-50%] top-5">Insira uma imagem</span>
                                        }
                                        <Image
